...
SELECT 'STUDY_PROGRAM_CODE' categoryCode, higherstudy_program_type_id code, higherstudy_program_type value, NULL parentCode, priority displayOrder 
FROM alumni2_higherstudy_program_types WHERE STATUS = 1 AND currentstatusid  = 9 UNION ALL
...
SELECT 'COMPANY_CODE' categoryCode, 'GOOGLE' code, 'Google' value, NULL parentCode, NULL displayOrder UNION ALL

SELECT 'JOB_TYPE_CODE' categoryCode, 'FULL_TIME' code, 'Full time' value, NULL parentCode, NULL displayOrder UNION ALL
SELECT 'JOB_TYPE_CODE' categoryCode, 'PART_TIME' code, 'Part time' value, NULL parentCode, NULL displayOrder UNION ALL
SELECT 'JOB_TYPE_CODE' categoryCode, 'FREELANCING' code, 'Freelancing' value, NULL parentCode, NULL displayOrder UNION ALL
SELECT 'JOB_TYPE_CODE' categoryCode, 'INTERNSHIP' code, 'Internship' value, NULL parentCode, NULL displayOrder
